...
class detector_Mask_RCNN(object):
    def __init__(self, filename_weights, path_root, obj_threshold=0.5):
        ...
        self.model = detector_Mask_RCNN_core.MaskRCNN(
            mode="inference", model_dir=path_root, config=config
        )
    ...
    def process_file(self, filename_in, filename_out, draw_spline=True):
        ...
        if draw_spline == False:
            ...
            r = self.model.detect([image], verbose=0)[0]
            boxes_yxyx, scores, classes, masks = (
                r["rois"],
                r["scores"],
                r["class_ids"],
                r["masks"],
            ...
            detector_Mask_RCNN_core.display_instances(
